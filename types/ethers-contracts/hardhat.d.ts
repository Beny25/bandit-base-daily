...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'BanditBase', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.BanditBase__factory>
getContractFactory(name: 'Counter', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.Counter__factory>

  getContractAt(name: 'BanditBase', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.BanditBase>
getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>

  deployContract(name: 'BanditBase', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BanditBase>
deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>

  deployContract(name: 'BanditBase', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BanditBase>
